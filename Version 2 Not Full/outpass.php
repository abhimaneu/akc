    ...
    <script>
                        ...
                        if (response === "FALSE") {
                            ...
                            if (l > 0)
                                for (i = 0; i < l; i++) {
                                    ...
                                    options += '<option selected value="' + productData[i].name + "||" + productData[i].size + '" data-qty="' + productData[i].qty + '">' + "" + '' + productData[i].name + '&nbsp;' + "" + '' + productData[i].size + '</option>';
                                }
        ...
        <div class='mb-2'>
         ...
         &nbsp;
          ...
          <input type='text' hidden class='custom_field w-100' name='custom_field[]' placeholder='Enter Product Name and Size in Correct Format (Name || Size)' >
          </div>
