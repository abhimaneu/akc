...
$sql2 = "select * from work_orders where work_order_no = '$workOrderNo'";
            ...
            success: function (response) {
                if (response === "FALSE") {
                    ...
                    for (var i = 0; i < l; i++) {
                        ...
                        productnopcsField.val(productData[i].qty);
                        productrmField.val(productData[i].qty);
                        producttotalunitField.val(productData[i].qty + " Nos")
